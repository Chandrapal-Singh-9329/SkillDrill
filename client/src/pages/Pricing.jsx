...
const Pricing = () => {
  ...
  return (
    <div
      className={`min-h-screen bg-gradient-to-br from-gray-50 to-emerald-50 py-16 px-6 transition-all duration-300 ${
        isPaymentOpen ? "blur-sm" : ""
      }`}
    >
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3 gap-8 max-w-6xl mx-auto">
        {plans.map((plan) => {
