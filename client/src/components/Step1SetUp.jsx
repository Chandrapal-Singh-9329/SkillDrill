...
const Step1SetUp = ({ onStart }) => {
  ...
  return (
    <motion.div
      ...
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 px-4 dark:from-gray-950 dark:to-gray-900"
    >
        ...
        >
          ...
          <div className="space-y-6">
            <div className="relative">
              <FaUserTie className="absolute top-4 left-4 text-gray-400 dark:text-white" />
              <input
                type="text"
            ...
            <div className="relative">
              <FaBriefcase className="absolute top-4 left-4 text-gray-400 dark:text-white" />
              <input
                type="text"
...
hover:bg-green-50 dark:hover:bg-gray-800 rounded-xl p-8 text-center cursor-pointer hover:border-green-500 hover:bg-green-50 transition"
              >
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {skills.map((s, i) => (
                        <span
                          key={i}
                          className="bg-green-100 dark:bg-green-900 text-green-700 dark:text-white px-3 py-1 rounded-full text-sm"
                        >
                          {s}
                        </span>
                      ))}
